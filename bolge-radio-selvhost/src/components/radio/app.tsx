...
import { Download, Pause, Pencil, Play, Plus } from "lucide-react";
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto overflow-x-hidden bg-bg text-fg">
      ...
      <header className="px-5 pt-[max(1.5rem,env(safe-area-inset-top))] pb-2">
        ...
        <a
          href="/bolge-radio-selvhost.zip"
          download="bolge-radio-selvhost.zip"
          className="mt-4 flex h-12 w-full items-center justify-center gap-2 rounded-md bg-surface text-sm font-medium text-fg shadow-[var(--shadow-border)] transition-transform duration-150 active:scale-[0.98]"
        >
